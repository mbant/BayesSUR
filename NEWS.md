...
Added random effects for mandatory variables by argument `X_0` with a specified (weakly) informative prior, and by argument `betaPrior="reGroup"`.

### Version `BayesSUR_1.2-4.tar.gz` (06 December 2020):
...
### Verion `BayesSUR_1.1-3.tar.gz` (23 June 2020):
