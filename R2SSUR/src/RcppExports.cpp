...
// R2SSUR_internal
int R2SSUR_internal(const std::string& dataFile, const std::string& blockFile, const std::string& structureGraphFile, const std::string& outFilePath, unsigned int nIter, unsigned int burnin, unsigned int nChains, const std::string& method, bool sparse, const std::string& gammaSampler, const std::string& gammaInit, bool usingGPrior);
RcppExport SEXP _R2SSUR_R2SSUR_internal(SEXP dataFileSEXP, SEXP blockFileSEXP, SEXP structureGraphFileSEXP, SEXP outFilePathSEXP, SEXP nIterSEXP, SEXP burninSEXP, SEXP nChainsSEXP, SEXP methodSEXP, SEXP sparseSEXP, SEXP gammaSamplerSEXP, SEXP gammaInitSEXP, SEXP usingGPriorSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(R2SSUR_internal(dataFile, blockFile, structureGraphFile, outFilePath, nIter, burnin, nChains, method, sparse, gammaSampler, gammaInit, usingGPrior));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_R2SSUR_R2SSUR_internal", (DL_FUNC) &_R2SSUR_R2SSUR_internal, 12},
    {NULL, NULL, 0}
};
