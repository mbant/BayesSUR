...
corr_param = 0.9 # in 0.3 , 0.6 , 0.9
  ...
  command = paste(sep="","./BVS_Reg --method SSUR --inFile ",justName,".txt --outFilePath results/ --nOutcomes ",s," --nPredictors ",p,"  --nChains 4 --nIter 250000")
  write(command,file="call.sh",append = TRUE)
  
  command = paste(sep="","# ./BVS_Reg --method dSUR --inFile ",justName,".txt --outFilePath results/ --nOutcomes ",s," --nPredictors ",p,"  --nChains 4 --nIter 250000 # this implies dense residual covariance")
  write(command,file="call.sh",append = TRUE)
  
  command = paste(sep="","./BVS_Reg --method HESS --inFile ",justName,".txt --outFilePath results/ --nOutcomes ",s," --nPredictors ",p,"  --nChains 4 --nIter 250000")
