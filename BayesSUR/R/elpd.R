...
#' 
#' @return Return the predictiion accuracy measure from an object of class \code{BayesSUR}. It is elpd.loo if the argumnet \code{method="LOO"} and elpd.WAIC if \code{method="WAIC"}.
#' 
