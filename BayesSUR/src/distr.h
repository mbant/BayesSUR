...
namespace Distributions{
    ...
    //extern double randU01();
    //extern double randT(const double);
    //extern int randIntUniform(const int, const int);
    //extern double randNormal(const double, const double);
    //extern double randExponential(const double);
    //extern arma::mat randWishart(double, const arma::mat&);
