...
hyperpar = list(mrf_e=-3, mrf_d=3/10, b_pi = 600, a_pi = 500 , b_o = 1.05 , a_o = 1 )
...
fit <- runSUR(data = example_data$data, Y = example_data$blockList[[1]],
              X = example_data$blockList[[2]], outFilePath = "results/", hyperpar=hyperpar,
              nIter = 300000, nChains = 2, covariancePrior = "HIW", burnin=100000,
              gammaPrior = "hotspot")
str(fit)
#
